        ...
        <div class="row">
          <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
            <div class="box-feature mb-4"  style="min-height: 430px;max-height: 430px">
              ...
              <p class="text-black-50">
                La société se charge de développer et de promouvoir des projets immobiliers, tels que la construction d'appartements,
                de maisons individuelles ou de villas.
              </p>
          ...
          <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
            <div class="box-feature mb-4"  style="min-height: 430px;max-height: 430px">
              ...
              <h3 class="text-black mb-3 font-weight-bold">Conseils et accompagnement :</h3>
              <p class="text-black-50">
          ...
          <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
            <div class="box-feature mb-4"  style="min-height: 430px;max-height: 430px">
              ...
              <h3 class="text-black mb-3 font-weight-bold">
                Étude de marché : </h3>
              <p class="text-black-50">
                Avant de lancer un projet immobilier, la société réalise des études de marché pour évaluer la demande et déterminer la faisabilité du projet.
              </p>
